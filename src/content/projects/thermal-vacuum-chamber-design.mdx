...
<figure className="mt-6 mb-6">
  ...
  <figcaption className="mt-3 text-center text-sm text-gray-500 italic">
    CAD model of cylindrical pressure vessel subjected to external atmospheric pressure.
  </figcaption>
</figure>
...
<figure className="mt-6 mb-6">
  ...
  <figcaption className="mt-3 text-center text-sm text-gray-500 italic">
    Finite Element Analysis showing stress distribution under external pressure.
  </figcaption>
</figure>
...
<figure className="mt-6 mb-6">
  ...
  <figcaption className="mt-3 text-center text-sm text-gray-500 italic">
    CAD model of cryoshroud assembly for heating and radiative cooling simulation.
  </figcaption>
</figure>
