...
period: "2022"
description: As part of capacity-building efforts for satellite testing infrastructure in Nepal, I contributed to the preliminary design of a Thermal Vacuum Chamber (TVC) intended for environmental qualification testing of CubeSats up to 6U configuration. A thermal vacuum chamber replicates the extreme vacuum and thermal conditions encountered in low Earth orbit. The objective of this project was to design a structurally sound, thermally capable, and economically feasible chamber suitable for small satellite validation within Nepal.
